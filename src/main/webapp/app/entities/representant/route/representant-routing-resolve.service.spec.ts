...
describe('Service Tests', () => {
  describe('Representant routing resolve service', () => {
    ...
    let resultRepresentant: IRepresentant | undefined;
    ...
    describe('resolve', () => {
      it('should return IRepresentant returned by find', () => {
        ...
        expect(resultRepresentant).toEqual({ id: 123 });
      });

      it('should return new IRepresentant if id is not provided', () => {
        // GIVEN
        ...
        expect(resultRepresentant).toEqual(new Representant());
      });
