...
@Component({
  selector: 'jhi-evaluation-cours-amenage',
  templateUrl: './evaluation-cours-amenage.component.html',
})
export class EvaluationCoursAmenageComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.evaluationCoursAmenageService
      ...
      .subscribe(
        (res: HttpResponse<IEvaluationCoursAmenage[]>) => {
  ...
  trackId(index: number, item: IEvaluationCoursAmenage): number {
    return item.id!;
  }

  delete(evaluationCoursAmenage: IEvaluationCoursAmenage): void {
  ...
  protected onSuccess(data: IEvaluationCoursAmenage[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/evaluation-cours-amenage'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
    ...
    this.evaluationCoursAmenages = data ?? [];
