...
@Component({
  selector: 'jhi-evaluation-cloture',
  templateUrl: './evaluation-cloture.component.html',
})
export class EvaluationClotureComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.evaluationClotureService
      ...
      .subscribe(
        (res: HttpResponse<IEvaluationCloture[]>) => {
  ...
  trackId(index: number, item: IEvaluationCloture): number {
    return item.id!;
  }

  delete(evaluationCloture: IEvaluationCloture): void {
  ...
  protected onSuccess(data: IEvaluationCloture[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/evaluation-cloture'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
